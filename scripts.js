...
const horizontalWin = () => {
  let firstRow = board[0][0][0]==='X' && board [0][1]==='X' && board[0][2] === 'X'
  let secondRow = board[0][0][0]==='X' && board [0][1]==='X' && board[0][2] === 'X'
  let thirdRow = board[0][0][0]==='X' && board [0][1]==='X' && board[0][2] === 'X'
